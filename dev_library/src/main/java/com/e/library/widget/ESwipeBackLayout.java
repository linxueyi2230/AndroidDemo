...
public class ESwipeBackLayout extends ViewGroup {
    ...
    public ESwipeBackLayout(Context context) {
        this(context, null);
    }

    public ESwipeBackLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void findScrollView(ViewGroup viewGroup) {
        ...
        if (viewGroup.getChildCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (child instanceof RecyclerView || child instanceof AbsListView || child instanceof ScrollView || child instanceof ViewPager || child instanceof WebView) {
                    scrollChild = child;
                    return;
                }
            }
    ...
    private void smoothScrollToX(int finalLeft) {
        if (viewDragHelper.settleCapturedViewAt(finalLeft, 0)) {
            ViewCompat.postInvalidateOnAnimation(ESwipeBackLayout.this);
        }
    }
