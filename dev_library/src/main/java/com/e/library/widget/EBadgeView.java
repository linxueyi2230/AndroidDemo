...
public class EBadgeView extends TextView {
    ...
    public EBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public EBadgeView(Context context, AttributeSet attrs, int defStyle) {
